        ...
        {items.map((item, idx) => (
          ...
          >
            <AnimatePresence>
              {hoveredIndex === idx && (
                <motion.span
                  className="absolute inset-0 h-full w-full bg-neutral-200 dark:bg-[#4f81ff73] block  rounded-3xl"
  ...
  export const CardTitle = ({
    ...
    return (
      <h4 className={cn("text-[#4f81ff] text-xl font-bold tracking-wide mt-4", className)}>
        {children}
      </h4>
    );
  };
